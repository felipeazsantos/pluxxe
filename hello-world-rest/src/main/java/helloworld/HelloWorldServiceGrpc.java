...
@javax.annotation.Generated(
    ...
    comments = "Source: src/main/proto/helloworld.proto")
...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<helloworld.Helloworld.Empty,
      helloworld.Helloworld.HelloWorldMessage> getGetMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMessage",
      requestType = helloworld.Helloworld.Empty.class,
      responseType = helloworld.Helloworld.HelloWorldMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<helloworld.Helloworld.Empty,
      helloworld.Helloworld.HelloWorldMessage> getGetMessageMethod() {
    io.grpc.MethodDescriptor<helloworld.Helloworld.Empty, helloworld.Helloworld.HelloWorldMessage> getGetMessageMethod;
    if ((getGetMessageMethod = HelloWorldServiceGrpc.getGetMessageMethod) == null) {
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getGetMessageMethod = HelloWorldServiceGrpc.getGetMessageMethod) == null) {
          HelloWorldServiceGrpc.getGetMessageMethod = getGetMessageMethod =
              io.grpc.MethodDescriptor.<helloworld.Helloworld.Empty, helloworld.Helloworld.HelloWorldMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helloworld.Helloworld.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helloworld.Helloworld.HelloWorldMessage.getDefaultInstance()))
              .setSchemaDescriptor(new HelloWorldServiceMethodDescriptorSupplier("GetMessage"))
              .build();
        }
      }
    }
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMessage(helloworld.Helloworld.Empty request,
        io.grpc.stub.StreamObserver<helloworld.Helloworld.HelloWorldMessage> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                helloworld.Helloworld.Empty,
                helloworld.Helloworld.HelloWorldMessage>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public helloworld.Helloworld.HelloWorldMessage getMessage(helloworld.Helloworld.Empty request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<helloworld.Helloworld.HelloWorldMessage> getMessage(
        helloworld.Helloworld.Empty request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MESSAGE:
          serviceImpl.getMessage((helloworld.Helloworld.Empty) request,
              (io.grpc.stub.StreamObserver<helloworld.Helloworld.HelloWorldMessage>) responseObserver);
          break;
        default:
